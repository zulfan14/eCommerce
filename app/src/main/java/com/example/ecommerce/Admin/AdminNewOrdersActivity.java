        ...
        FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder> adapter =
                new FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull AdminOrdersViewHolder holder, final int position, @NonNull final AdminOrders model)
                    {
                        ...
                        holder.userPhoneNumber.setText("No Telepon : " + model.getPhone());
                        holder.userTotalPrice.setText("Total Harga : " + model.getTotalAmount());
                        holder.userDateTime.setText("Tanggal dan Waktu : " + model.getDate() + " " +model.getTime());
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener()
                        {
                            ...
                            public void onClick(View v)
                            {
                                ...
                                builder.setTitle("Apakah Anda Sudah Mengirim Orderannya? ");
